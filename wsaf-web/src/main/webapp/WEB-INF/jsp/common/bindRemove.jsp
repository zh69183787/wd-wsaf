                      ...
                      if(data.success){
                         if(data.result!=null && data.result.length>0){
                            ...
                            for(var i=0;i<data.result.length;i++){
                                if(i==0){
                                  items+="<li class=\""+ptype+"\" draggable=\"true\"><a href=\"#\">"+convert(ptype)+"</a></li>";
                                }
                                items+="<li class=\""+data.result[i].ntype+"\" draggable=\"true\"><a href=\"#\">"+convert(data.result[i].ntype)+"</a></li>";
                            }
...
<!--   <p style="margin-left:5px;">是否绑定数据.</p> -->
  <p style="margin-left:5px;">是否解除绑定？</p>
</div>
	<form>
		<div class="v-center">
			<div class="v-menu">
