...
$(function(){
	$("#uploadify").uploadify({
		'auto' : false,
	       ...
	       'uploader' : '<%=basePath%>/basicCrud/user/uploadify',
       ...
       'onUploadSuccess' : function(file, data, response){
    	   var resultdata = jQuery.parseJSON(data);
       		$("#fileTable").show();
       		var addHtml = "<a href='<%=basePath%>/basicCrud/user/downloadFile.action?fileName="+resultdata.newFileName+"&file="+resultdata.ymd+"'>"+resultdata.fileName+"</a>";				
       		$("#showTR").show();
       		$("#showId").html(addHtml);
    	}
	});
