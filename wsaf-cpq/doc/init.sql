...
------------------------------------------------------------------CPT--------------------------------------------------- 
insert into af_ccate(id,type,name,description) values(seq_af_ccate.nextval,'situationtype','监督投诉情况分类','监督投诉情况分类字典类')
insert into af_codes(id,ccate_id,code,display,description,orders) values(seq_af_codes.nextval,546,'massWork','党群工作类','党群工作类',1);
insert into af_codes(id,ccate_id,code,display,description,orders) values(seq_af_codes.nextval,546,'admimBusiness','行政业务类','行政业务类',2);
insert into af_codes(id,ccate_id,code,display,description,orders) values(seq_af_codes.nextval,546,'disciplineSupervise','纪检监察类','纪检监察类',3);

------------------------------------------------------------------ACT--------------------------------------------------- 
insert into af_ccate(id,type,name,description) values(seq_af_ccate.nextval,'collectSuggesttype','征集意见类别','征集意见类别字典类')
insert into af_codes(id,ccate_id,code,display,description,orders) values(seq_af_codes.nextval,558,'partyCategory','党群类','党群类',1);
insert into af_codes(id,ccate_id,code,display,description,orders) values(seq_af_codes.nextval,558,'manageCategory','管理类','管理类',2);
insert into af_codes(id,ccate_id,code,display,description,orders) values(seq_af_codes.nextval,558,'technologCategory','技术类','技术类',3);
insert into af_codes(id,ccate_id,code,display,description,orders) values(seq_af_codes.nextval,558,'specialCategory','专题类','专题类',4);
