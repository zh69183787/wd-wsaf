...
String configPath = Thread.currentThread().getContextClassLoader().getResource("iasConfig.properties").getPath();
try {
...
<%! 
    ...
    private String toHex(byte[] buffer){  
     ...
     private void saveCookie(HttpServletResponse response,String Name,String value) throws UnsupportedEncodingException{
    		Cookie cookie = new Cookie("ias_"+Name, java.net.URLEncoder.encode(value,"utf-8"));
			cookie.setPath("/");		
