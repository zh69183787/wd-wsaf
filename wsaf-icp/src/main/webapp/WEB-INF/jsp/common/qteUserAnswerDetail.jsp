		...
		<script type="text/javascript">
				$(document).ready(function(){
				 ...
				 $.ajax({
				    ...
				    $.getRadioAnswerDetail("${pageContext.request.contextPath}",loginName);
				    $.getFillAnswerDetail("${pageContext.request.contextPath}",loginName);
...
<!--                            	  </div> -->
                          ...
                          <div class="mb10 t_c">
                              <input type="button" id="closeBtn" value="返回" />&nbsp;
                          </div>
