		                ...
		                $("#dialog-confirm").dialog({
		                    ...
		                    buttons: {
		                        "确认": function () {
		                            ...
		                            $.postSaveQuestion("${pageContext.request.contextPath}", "qteQuestionForm", "/qteQuestion/qteQuestionAdd?mainId="+mainId);
		                        },
		                        "取消": function () {
		                            $(this).dialog("close");
		                        }
...
<!--                 	<li><a href="#">首页</a></li> -->
        ...
        <div class="filter">
            <div class="fn clearfix">
            	<h5 class="fl"><a  class="colSelect fl">修改问题</a></h5>
            </div>
        </div>
        <!--Filter End-->
        <!--Table-->
          ...
          <form id="qteQuestionForm" >
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                                ...
                                <td>
                                	<select name="quesType" id="quesType" class="input_large">
                                ...
                                <td><input type="text" id="quesOrders" name="quesOrders" placeholder="输入题号" /></td>
                                <td ></td>
                                <td><input type="hidden" name="isDisplay" id="isDisplay" value="true" >
<!--                                 	<select name="isDisplay" id="isDisplay" class="input_large"> -->
...
<!--                                 	</select> -->
                              ...
                              <tr>
                                ...
                                <td>
                                	<select name="groupId" id="groupId" class="input_large">
                                	</select>
                                </td>
                              </tr>
                              <tr>
                                <td class="t_r lableTd">题干内容</td>
                                <td colspan="3"><textarea id="quesContent" name="quesContent" rows="3" placeholder=""></textarea></td>
                              	<td></td>
                                <td></td>
                              </tr>
...
<!--                               </tr> -->
                              ...
                              <tr>
                                ...
                                <td colspan="3"><textarea id="remark" name="remark" rows="3" placeholder=""></textarea></td>
                              	<td></td>
                                <td></td>
                              </tr>
                              </tbody>
