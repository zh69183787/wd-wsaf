		...
		<script type="text/javascript">
			$(document).ready(function () {
				...
				$("#addQuestion").click(function(){
						window.open("${pageContext.request.contextPath}/qteQuestion/qteQuestionAdd?mainId="+mainId);
				});
                ...
                if (confirm("确认删除该条记录吗？")) {
                    $.ajax({
                        url: "${pageContext.request.contextPath}" + "/basicCrud/qteQuestion/del/" + $(this).attr("quesId"),
                        type: 'post',
                        dataType: 'json',
                        success: function (data, status, xhr) {
                            if (status == "success" && data != null) {
                                if (data.success == true) {
                                    alert("操作成功！");
                                    location.href = "${pageContext.request.contextPath}/qteQuestion/qteQuestionList?id="+mainId;
                ...
                <div class="divB">
                	...
                	<div class="con">
						<ul class="button clearfix">
                        	<li><a target="_blank" style=" cursor :pointer;" id="addQuestion"  class="imp">添加试题</a></li>
                        </ul>
                	</div>
                </div>
                <div class="divF"></div>
