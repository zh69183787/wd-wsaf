        ...
        $(document).ready(function () {
			...
			if ($tblAlterRow.length > 0)
				...
				$("#editGroup").click(function(){
					...
					$.postSaveMain("${pageContext.request.contextPath}", "editGroupForm", "/qteGroup/qteGroupList");
				});
			...
			$("#add").click(function(){
				window.open("${pageContext.request.contextPath}/qteGroup/qteGroupEdit?id="+mainId);
			});	
             ...
             <table class="nwarp" width="100%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                   <td colspan="4" class="t_c">
                     <input type="button" name="editGroup" id="editGroup" value="修改" />&nbsp;
                     <input type="button" name="cancle" id="cancle" value="重置" />
                     <input type="button" name="add" id="add" value="新增" class="fr">
                  </td>
                 </tr>
             </table>
