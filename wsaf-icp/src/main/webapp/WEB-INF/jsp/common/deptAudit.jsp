...
<head>
       ...
       <![endif]-->
		...
		<script src="js/deptAduit.js"></script>
		<script type="text/javascript">
        $(function () {
        	var mainId="${mainId}";
        	//第一步：根据mianId获取问卷信息
	...
	<div class="main">
		...
		<div class="ctrl clearfix">
            ...
            <div class="posi fl">
            	<ul>
                	<li><a href="#">问卷审核</a></li>
                	<li class="fin">部门领导审核</li>
                </ul>
            </div>
            <div class="posi fr nwarp">
            	<ul>
                	<li class="fin"><a target="_blank" href="javascript:void(0);" id="btnClose">关闭</a></li>
                </ul>
            </div>
          ...
          <form id="qteMainForm">
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                               ...
                               <tr>
                                <td class="t_r lableTd">条线管理员</td>
                                <td colspan="3">
                                    <input readonly id="lineHeadName" name="lineHeadName" type="text" class="input_large" disabled="disabled">
                                     <input readonly id="lineHeadLoginName" name="lineHeadLoginName" type="hidden" >
                                </td>
                                <td></td>
                                <td></td>
                              </tr>
