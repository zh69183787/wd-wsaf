...
//                              $.FileSave("${pageContext.request.contextPath}","complaint",_id,_attachIds);
                            ...
                            $.postSaveMain("${pageContext.request.contextPath}", "cptComplaintForm", otherData, "/cptComplaint/cptComplaintEditV");
                            $(this).dialog("close");
                            alert("操作成功！");
        ...
        <div class="mb10">
          <form id="cptComplaintForm">
        	<table width="100%"  class="table_1">
                              ...
                              <tr>
                                <td class="t_r lableTd" style="font-weight:bold;">监督投诉<input type="hidden"  name="id" id="id"/></td>
                                <td colspan="3"></td>
                              </tr>
          ...
          <div class="mb10 t_c"  >
                          <table width="100%" class="table_1">
                            ...
                            <input type="button" id="btnSubmit" value="修改" />&nbsp;
