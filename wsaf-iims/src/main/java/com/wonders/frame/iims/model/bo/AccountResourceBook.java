 ...
 */
@Entity
@Table(name = "IIMS_ACCOUNT_RESOURCE_BOOK")
@ShowInView(name="账户资源台帐")
public class AccountResourceBook implements java.io.Serializable {
	@ShowInView(noUse=true)
	private static final long serialVersionUID = 1234030709012949219L;
	...
	/** default constructor */
	public AccountResourceBook() {
		this.removed=0;
	}

	/** minimal constructor */
	public AccountResourceBook(Integer id, String userName, String contactPhone,
	...
	@SequenceGenerator(name = "Generator", sequenceName  = "seq_iims_account_resource_b",allocationSize=1)
