 ...
 */
@Entity
@Table(name = "IIMS_WIRELESS_RESOURCE_BOOK")
@ShowInView(name="无线网络资源台账")
public class WirelessResourceBook implements java.io.Serializable {

	@ShowInView(noUse=true)
	private static final long serialVersionUID = 5456088704322079856L;
	...
	@ShowInView(name="申请业务类型",operateType=OperateType.SELECT,ccateType="wirelessBusinessType")
	...
	@ShowInView(name="终端类型",operateType=OperateType.SELECT,ccateType="wirelessTerminalType")
	...
	/** default constructor */
	public WirelessResourceBook() {
		this.removed=0;
	}

	/** minimal constructor */
	public WirelessResourceBook(Integer id, String userName, String contactPhone,
	...
	/** full constructor */
	public WirelessResourceBook(Integer id, String userName, String contactPhone,
			String userPost, String sysName,
	...
	@SequenceGenerator(name = "Generator", sequenceName  = "seq_iims_wireless_resource_b",allocationSize=1)
