...
@Component
@Aspect
public class SecurityRiskAspect {
	private static Logger logger=LoggerFactory.getLogger(SecurityRiskAspect.class);
	@Resource
	 ...
	 * 指定切入点 
	 */
	@Pointcut("execution(* com.wonders.frame.iims.dao.SecurityRiskDao.save(..))")
	public void saveOrUpdateSecurityRisk(){}
	/**
	 * 添加操作日志(后置通知) 
	 * @param joinPoint
	 * @param rtv
	...
	@AfterReturning(value="saveOrUpdateSecurityRisk()",argNames="rtv", returning="rtv")
	public void addSecurityRiskLog(JoinPoint joinPoint, Object rtv) throws Throwable{
