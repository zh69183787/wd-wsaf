 ...
 */
@Entity
@Table(name = "IIMS_VIRTUAL_RESOURCE_BOOK")
@ShowInView(name="虚拟化资源台帐")
public class VirtualResourceBook implements java.io.Serializable {
	@ShowInView(noUse=true)	
	private static final long serialVersionUID = 5492711792710316051L;
	...
	/** default constructor */
	public VirtualResourceBook() {
		this.removed=0;
	}

	/** minimal constructor */
	public VirtualResourceBook(Integer id, String userName,
	...
	@SequenceGenerator(name = "Generator", sequenceName  = "seq_iims_virtual_resource_b",allocationSize=1)
