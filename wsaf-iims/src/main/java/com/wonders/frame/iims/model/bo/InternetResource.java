 ...
 */
@Entity
@Table(name = "IIMS_INTERNET_RESOURCE")
@ShowInView(name="互联网资源")
public class InternetResource implements java.io.Serializable {
	@ShowInView(noUse=true)
	private static final long serialVersionUID = -5024343069005770337L;
	...
	/** minimal constructor */
	public InternetResource(Integer id, String userName, String contactPhone,
	...
	@SequenceGenerator(name = "Generator", sequenceName  = "seq_iims_internet_resource",allocationSize=1)
