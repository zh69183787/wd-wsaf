...
@Component
@Aspect
public class SecurityIssueAspect {
	private static Logger logger=LoggerFactory.getLogger(SecurityIssueAspect.class);
	@Resource
	 ...
	 * 指定切入点 
	 */
	@Pointcut("execution(* com.wonders.frame.iims.dao.SecurityIssueDao.save(..))")
	public void saveOrUpdateSecurityIssue(){}
	/**
	 * 添加操作日志(后置通知) 
	 * @param joinPoint
	 * @param rtv
	...
	@AfterReturning(value="saveOrUpdateSecurityIssue()",argNames="rtv", returning="rtv")
	public void addSecurityIssueLog(JoinPoint joinPoint, Object rtv) throws Throwable{
		...
		String processName="信息"+entityProperty.getCnName();
		//默认发送待办事项及短信		
		//记录流转日志并发送待办项及短信
