...
public class SecurityLevelAspect {
	private static Logger logger=LoggerFactory.getLogger(SecurityLevelAspect.class);
	@Resource
	 ...
	 * 指定切入点 
	 */
	@Pointcut("execution(* com.wonders.frame.iims.dao.SecurityLevelDao.save(..))")
	public void saveOrUpdateSecurityLevel(){}
	/**
	 * 添加操作日志(后置通知) 
	 * @param joinPoint
	 * @param rtv
	...
	@AfterReturning(value="saveOrUpdateSecurityLevel()",argNames="rtv", returning="rtv")
	public void addSecurityLevelLog(JoinPoint joinPoint, Object rtv) throws Throwable{
