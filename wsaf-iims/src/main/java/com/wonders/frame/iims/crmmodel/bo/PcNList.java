...
@Entity
@Table(name="pc_n_list")
public class PcNList implements Serializable{
	...
	/** full constructor */
	public PcNList(String serialNo, String lineNo, String buildAddress,
	...
	public String toString() {
		return "PcNList [serialNo=" + serialNo + ", lineNo=" + lineNo
