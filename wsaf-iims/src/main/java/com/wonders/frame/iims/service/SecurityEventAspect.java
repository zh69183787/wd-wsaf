...
public class SecurityEventAspect {
	 ...
	 * 指定切入点 
	 */
	@Pointcut("execution(* com.wonders.frame.iims.dao.SecurityEventDao.save(..))")
	public void saveOrUpdateSecurityEvent(){}
	/**
	 * 添加操作日志(后置通知) 
	 * @param joinPoint
	 * @param rtv
	...
	@AfterReturning(value="saveOrUpdateSecurityEvent()",argNames="rtv", returning="rtv")
	public void addSecurityEventLog(JoinPoint joinPoint, Object rtv) throws Throwable{
