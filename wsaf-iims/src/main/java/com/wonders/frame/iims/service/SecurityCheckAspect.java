...
public class SecurityCheckAspect {
	private static Logger logger=LoggerFactory.getLogger(SecurityCheckAspect.class);
	@Resource
	 ...
	 * 指定切入点 
	 */
	@Pointcut("execution(* com.wonders.frame.iims.dao.SecurityCheckDao.save(..))")
	public void saveOrUpdateSecurityCheck(){}
	/**
	 * 添加操作日志(后置通知) 
	 * @param joinPoint
	 * @param rtv
	...
	@AfterReturning(value="saveOrUpdateSecurityCheck()",argNames="rtv", returning="rtv")
	public void addSecurityCheckLog(JoinPoint joinPoint, Object rtv) throws Throwable{
