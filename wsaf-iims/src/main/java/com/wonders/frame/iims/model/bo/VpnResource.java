 ...
 */
@Entity
@Table(name = "IIMS_VPN_RESOURCE")
@ShowInView(name="VPN资源")
public class VpnResource implements java.io.Serializable {
	@ShowInView(noUse=true)
	private static final long serialVersionUID = 1916371542743241316L;
	...
	/** minimal constructor */
	public VpnResource(Integer id, String userName, String contactPhone,
	...
	@SequenceGenerator(name = "Generator", sequenceName  = "seq_iims_vpn_resource",allocationSize=1)
