                        ...
                        $.each(data.result.content, function (entryIndex, entry) {
                            ...
                            var newpage = "",strBtn="详情";
                                ...
                                if (entry.status == "draft" || entry.status == "infoDeptBack" ) {
                                    newpage = "securityIssueEdit";
                                    strBtn="修改";
                                }
                                else {
                                    newpage = "securityIssueDetail";
                                    strBtn="详情";
                                }
        ...
        <div class="pt45">
            ...
            <div class="filter">
                ...
                <div class="fn clearfix">
                    ...
                    <input type="button" id="addbtn" value="新 增" onclick="window.open('${pageContext.request.contextPath}/securityIssue/securityIssueAdd');" class="fr">
                </div>
            </div>
            <!--Filter End-->
            <!--Table-->
