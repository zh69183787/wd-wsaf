  ...
  <head>
    ...
    <script type="text/javascript">
		 $(document).ready(function () {
        	$.postSearchFormVpn("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
        	window.onfocus = function(){
        		var _page="1";
        		if($(".selected a").length>0&&$(".selected a").text()!="")
        			_page=$(".selected a").text();
        		
              $.postSearchFormVpn("${pageContext.request.contextPath}","&pageSize=16&pageNum="+_page); 
          	 };
		...
		function close(){
			...
			function open(id){
				var a = document.getElementById("iframe_xx");
				a.style.display="";
				$.findByIdVpn("${pageContext.request.contextPath}",id);
				}
			function open2(id){
			...
			function del(id){
				$.delByIdVpn("${pageContext.request.contextPath}",id);
				}
			function save(id){
				var otherData="&status=finish";
           		 otherData+="&id="+id;
				$.postsaveVpn("${pageContext.request.contextPath}","vpnResource",otherData);
			}
        ...
        <div class="pt45">
                    ...
                    <div class="tabs_2">
                        <ul>
                            ...
                            <li class="selected"><a href=""><span>VPN台帐</span></a></li>
                 ...
                 <form id="projectAppform">
                  <table class="nwarp" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                     ...
                     <td class="t_r">访问权限</td>
                      <td><input type="text" id="lreportUnit" name="permissions" /></td>
                    </tr>
                  	<tr>
                        <td class="t_r">VPN账户名</td>
                      <td><input type="text" id="lreportUnit" name="accountName" /></td>
                      <td class="t_r">办理人</td>
        	...
        	<table width="100%"  class="table_1" id="table1">
                <tbody>
                   <tr class="tit">
                       ...
                       <td class="sort"><a ><span class="fl">开通账号</span></a></td>
