    ...
    <script type="text/javascript">
		 $(document).ready(function () {
		  $(".closewindow").click(function(){
        	...
        	$.postSearchFormInfoManage("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
        	window.onfocus = function(){
        		var _page="1";
        		if($(".selected a").length>0&&$(".selected a").text()!="")
        			_page=$(".selected a").text();
        		
              $.postSearchFormInfoManage("${pageContext.request.contextPath}","&pageSize=16&pageNum="+_page); 
          	 };
				   ...
				   {	
											...
											var _str3="";
											  $("[name=btnISPass]").click(function(){
													...
													case"pass":
														...
														i+=1;
														if(_str3==""){
													      _str3+="<tr name="+i+" class=\"reviewPerson\"><td colspan=\"2\">选择审批领导</td></tr><tr name="+i+" class=\"reviewPerson\"> <td class=\"td_1\">&nbsp;</td><td><input type=\"radio\" name=\"cbReview\" value=\"G001000002232549\"/>&nbsp;黄天印</td></tr>";
													      _str3+="<tr name="+i+" class=\"reviewPerson\"> <td class=\"td_1\">&nbsp;</td><td><input type=\"radio\" value=\"G020001000492549\" name=\"cbReview\"/>&nbsp;金涛</td></tr><tr  class=\"reviewPerson\"> <td class=\"td_1\">&nbsp;</td>";
													         $("#mysug").after(_str3);
												         }
												         $("[name="+i+"]").css("display","");
												         if(i>1){
												...
												if($("input[name=btnISPass]:checked").val()=="pass")
										         {
													 ...
													 otherData+="&id="+id+$.getPerson(firUrl);
					...
					$("#auditBtn").click(function(){
						...
						for(var i = 0; i<a.length;i++){
							if(a[i].checked){
								id = a[i].value;
								if($("#"+id).text()=="待信息中心审核"||$("#"+id).text()=="信息中心领导退回"){
									$("[name=suggestion]").val("");
