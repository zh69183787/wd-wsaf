                                    ...
                                    $("#btnSubmit2").click(function () {
                                        if ($("input[name=btnISPass]:checked").val() == "pass") {
                                            ...
                                            if (id != null) {
                                                ...
                                                otherData += "&id=" + id + "&businessStatus=underway&status=pass" + "&initiateTime=" + d.getTime();
                                            }
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr id="reviewinfo">
                    ...
                    <td>
                        ...
                        信息管理中心领导审核意见：<input name="btnISPass" type="radio" value="pass" style="margin-left: 20px">通过<input name="btnISPass" type="radio" value="notPass" style="margin-left: 10px">不通过</td>
