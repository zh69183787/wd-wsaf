												...
												if($("input[name=btnISPass]:checked").val()=="pass")
										         {
													 var otherData="";var d = new Date();
														 ...
														 otherData+="&id="+QueryString.GetValue('id')+$.getPerson(firUrl)+"&handler=方政&handlerLoginname=G010070003832549&status=waitForImplement";
								                	...
								                	window.close();
													location.href = Url
															+ "/virtualResource/virtualResourceInfoLeaderList";
                ...
                <div class="divB">
                	...
                	<div class="con">
						...
						<ul class="button clearfix" style="filter:Gray">
                        	...
                        	<li class="disable"><a  class="bat" href="/iims/virtualResource/virtualResourceInfoLeaderList">批量审核</a></li>
