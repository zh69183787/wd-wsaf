    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#btndel").click(function () {
              	 ...
              	 $.postSave({"url":"${pageContext.request.contextPath}","formName":"projectPlanForm","modname":"securityRisk","otherData":"&removed=1&id=" + QueryString.GetValue('id'),"isClose":true});
              });
