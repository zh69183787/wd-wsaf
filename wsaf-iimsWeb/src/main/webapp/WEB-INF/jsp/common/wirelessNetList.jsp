...
<html>
  <head>
    ...
    <script type="text/javascript">
		...
		function add(firUrl){
			window.open("/iims/wirelessResource/wirelessNetAdd");
		}
        ...
        <div class="pt45">
                    ...
                    <div class="tabs_2">
                        <ul>
                            ...
                            <li class="selected"><a ><span>无线网络</span></a></li>
        	...
        	<table width="100%"  class="table_1">
                <tbody>
                   <tr class="tit">
                       ...
                       <td class="sort"><a ><span class="fl">用途</span></a></td>
