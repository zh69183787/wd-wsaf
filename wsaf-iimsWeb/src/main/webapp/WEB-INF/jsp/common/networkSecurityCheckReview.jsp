...
$(function(){
	...
	$("[name=btnISPass]").attr("disabled","");
	$("[name=suggestion]").attr("disabled","");
	$("#btnSubmit2").attr("disabled","");
	QueryString.Initial();
	...
	$.postAudit("${pageContext.request.contextPath}",QueryString.GetValue('id'));
...
<body>
 <div id="bt" class="transparent" style="display:none"></div>
	...
	<div class="main">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0"
							...
							<tbody id="tb1">
								...
								<tr>
									...
									<td colspan="3">
									<input disabled type="text" class="input_large" name="company" />
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2" id="table_3" style="display:none">
            ...
            <tbody>
				...
				<tr>
					...
					<td id="problem">
						<div><textarea  rows="4" id="problem_1" style="margin-top:0px;margin-bottom:0px;height:89px;"></textarea></div>
					</td>
				</tr>
            	...
            	<tr>
					...
					<td id="risk">
						<div><textarea  rows="4" id="risk_1" style="margin-top:0px;margin-bottom:0px;height:89px;"></textarea></div>
					</td>
				</tr>
				...
				<tr>
					...
					<td id="judge">
						<div><textarea  rows="4" id="judge_1" style="margin-top:0px;margin-bottom:0px;height:89px;"></textarea></div>
					</td>
				</tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2" id="table_4">
			<thead>
              <th colspan="10" class="f1"><h5 class="fl">审批信息</h5></th>
            </thead>
             <tbody><tr><td></td></tr> </tbody>
				...
				<div class="fn clearfix t_c">
					...
					<input type="button" id="btnClose" value="关 闭" class="b"/>
				</div>
			</div>
			<!--Filter End-->
