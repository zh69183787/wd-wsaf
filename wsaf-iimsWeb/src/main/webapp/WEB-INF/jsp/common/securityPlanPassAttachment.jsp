    ...
    <script type="text/javascript">
        $(function () {
            ...
            if (QueryString.GetValue('id') != null) {
                ...
                $.planTypeSp2({"url":"${pageContext.request.contextPath}","type":2,"planId":QueryString.GetValue('id')});
                ...
                $("#planType li").planTypeSp({"url":"${pageContext.request.contextPath}","type":2,"planId":QueryString.GetValue('id')});
