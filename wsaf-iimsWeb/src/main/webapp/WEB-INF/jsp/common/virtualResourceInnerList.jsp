    ...
    <script type="text/javascript">
		 $(document).ready(function () {
		  $(".closewindow").click(function(){
        	...
        	$.postSearchFormInner("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
        	window.onfocus = function(){
        		var _page="1";
        		if($(".selected a").length>0&&$(".selected a").text()!="")
        			_page=$(".selected a").text();
        		
              $.postSearchFormInner("${pageContext.request.contextPath}","&pageSize=16&pageNum="+_page); 
          	 };
										...
										if($("input[name=btnISPass]:checked").val()=="pass")
								         {
											 var otherData="";var d = new Date();
												 ...
												 otherData+="&id="+id+$.getPerson(firUrl)+"&handler=方政&handlerLoginname=G010070003832549&status=infoDeptApproval";
		...
		function add(firUrl){
			window.open("/iims/virtualResource/virtualAdd");
		}
