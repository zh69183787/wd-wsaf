	...
	var isleader= $.isleader("${pageContext.request.contextPath}");
	 $("#upload").uploadify({
         'auto' : false,
            ...
            'uploader' : '<%=basePath%>attach/api/upload?groupName="resourceManage"',
            			 ...
            			 _od+="&initiatorLoginname="+$("[name=applyerLoginname]").val();
	                	   ...
	                	   if(_yanz!="")
	                		   ...
	                		   return false;
	                	   	  ...
	                	   	  $.FileSave("${pageContext.request.contextPath}","resourceManage",fid,_attachIds);
	                	   	  window.close();
            ...
            <form id="projectPlanForm">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
               ...
               <tr>
                ...
                <tr>
                	<td id="reason" class="lableTd t_r"><div class="red" id="red" > *</div>用途</td>
                  	<td colspan="3"><textarea  rows="4" placeholder="描述该业务用途及网络数量信息" name="applyReason" 
