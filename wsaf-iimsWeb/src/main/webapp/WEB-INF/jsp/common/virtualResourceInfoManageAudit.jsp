											 ...
											 $("#bt").css("display","block");
											  ...
											  $("[name=btnISPass]").click(function(){
													...
													case"pass":
														...
														_str2="提交到信息中心领导审批";
														if(_str3==""){
													      _str3+="<tr name=\"lingdao\" class=\"reviewPerson\"><td colspan=\"2\">选择审批领导</td></tr><tr name=\"lingdao\" class=\"reviewPerson\"> <td class=\"td_1\">&nbsp;</td><td><input type=\"radio\" name=\"cbReview\" value=\"G001000002232549\"/>&nbsp;黄天印</td></tr>";
													      _str3+="<tr name=\"lingdao\" class=\"reviewPerson\"> <td class=\"td_1\">&nbsp;</td><td><input type=\"radio\" value=\"G020001000492549\" name=\"cbReview\"/>&nbsp;金涛</td></tr><tr  class=\"reviewPerson\"> <td class=\"td_1\">&nbsp;</td>";
													         $("#mysug").after(_str3);
												         }
												         $("[name=lingdao]").css("display","");
												...
												if($("input[name=btnISPass]:checked").val()=="pass")
										         {
													 ...
													 var cbReview=$("input[name=cbReview]:checked");
													 otherData+="&id="+QueryString.GetValue('id')+$.getPerson(firUrl);
													 if(cbReview.val()=="G001000002232549"){
														 otherData+="&handler=黄天印";
													 }else{
														 otherData+="&handler=金涛";
													 }
														 otherData+="&handlerLoginname="+cbReview.val()+"&status=infoDeptLeaderApproval";
								                	...
								                	window.close();
													location.href = Url
															+ "/virtualResource/virtualResourceInfoManageList";
													 ...
													 var data=$.getPerson(firUrl);
														otherData+=data+"&handler="+entry.applyer+"&handlerLoginname="+entry.applyerLoginname+"&status=infoDeptBack";
                ...
                <div class="divB">
                	...
                	<div class="con">
						...
						<ul class="button clearfix" style="filter:Gray">
                        	...
                        	<li class="disable"><a  class="bat" href="/iims/virtualResource/virtualResourceInfoManageList">批量审核</a></li>
