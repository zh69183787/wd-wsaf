...
$(function() {
	 ...
	 $("[name=paied]").blur(function (){
		...
		}else if(planPay<paied){
			 alert("本年已支付不能大于本年计划支付");
		}else{
	 ...
	 $("[name=totalPaied]").blur(function (){
		...
		}else if(signAmount<totalPaied){
			 alert("累计支付不能大于合同签订金额");
		}else{
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
               ...
               <tr>
                ...
                <tr>
                 ...
                 <tr>
                   ...
                   <td class="lableTd t_r"><div class="red"> *</div>支付完成率</td>
                  	<td><input  type="text" readonly class="input_large" id="percent" />
                ...
                <td class="lableTd t_r"><div class="red"> *</div>累计支付率</td>
                   <td ><input  type="text" readonly class="input_large" id="totalPaiedPercent" />
