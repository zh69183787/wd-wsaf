...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            $("[name=startUserDate]").datepicker({ dateFormat:"yy-mm-dd"}).click(function(){$(".ui-state-default").removeAttr("href"); });
            $("[name=levelConfirmDate]").datepicker({ dateFormat:"yy-mm-dd"}).click(function(){$(".ui-state-default").removeAttr("href"); });
            $("[name=sysLevelReviewDate]").datepicker({ dateFormat:"yy-mm-dd"}).click(function(){$(".ui-state-default").removeAttr("href"); });
            ...
            $.postSecurityLevelDetail = function (firUrl, departName) {
                if (firUrl != "") {
                    $.ajax({
                        async: false,
                        url: firUrl + "/basicCrud/securityLevelCompany/page?companyId=" + departName + "&pageSize=1",
                        type: 'post',
                        success: function (data, status, xhr) {
            ...
            $.postSecurityLevelDetail("${pageContext.request.contextPath}", $("[name=reportUnitId]").val());
            ...
            $(".btnSubmit").click(function () {
                ...
                var otherData = "&status=" + mystate + "&businessStatus=new&keyProducts={\"security\":\"{\\\"num\\\":\\\"" + $("#securityNum").val();
                ...
                otherData += "&sysSecurityLevel=level";
                                ...
                                <form id="projectPlanForm">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input class="input_large" name="company" readonly="readonly"/><input style="display:none" class="input_large" name="companyId" readonly="readonly"/></td>
                                        </tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input type="text" readonly="readonly" class="input_large" name="levelConfirmDate" maxlength="10" /></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2" id="applyInfo">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input type="text" class="input_large" readonly="readonly" name="sysLevelReviewDate" maxlength="30" /></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">专家评审情况</td>
                                            <td colspan="3">
