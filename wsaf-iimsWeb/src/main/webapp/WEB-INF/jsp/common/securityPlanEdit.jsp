...
<head>
    ...
    <script type="text/javascript">
        $(function () {  
            ...
            {
                if($.postSecurityPlanDetailSp2rd("${pageContext.request.contextPath}","planId="+QueryString.GetValue('id'))>0)
            ...
            $(".btnSubmit").click(function () {
                ...
                var otherData = "&id="+ QueryString.GetValue('id')+"&company=" + $("[name=company] option:selected").val() + "&businessStatus=new&status=" + mystate + "&applyTime=" + d.getTime() + "&initiateTime=" + d.getTime();
            ...
            $("#btndel").click(function () {
                $(this).attr("disabled", true);
                $.postSave({"url":"${pageContext.request.contextPath}","formName":"projectPlanForm","modname":"securityPlan","otherData":"&removed=1&id=" + QueryString.GetValue('id'),"isClose":true});
            });      
        })
                                ...
                                <form id="projectPlanForm">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                        ...
                                        <tr class="companyAddress">
                                            ...
                                            <td colspan="3">
                                                <select name="planYear" class="input_small" maxlength="4"></select>
                                            </td>
                                        </tr>
                                    </table>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2" id="applyInfo">
                                        ...
                                        <tr>
                                            <td class="lableTd t_r">审查人</td>
                                            <td>
                                                <select id="principalPeople" style="width: 260px;" name="handlerLoginname" >
                                                    <option value="">请选择</option>
                                                </select>
                                            </td>
