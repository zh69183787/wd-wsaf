		 ...
		 $(document).ready(function () {
           ...
           $("#oututBtn").click(function(){
        	  var paging="";
         	  ...
         	  window.location.href="${pageContext.request.contextPath}"+"/basicCrud/netResource/export2Excel?"+content+"&type=netResource";
...
<body class="Flow">
	<div class="main">
        ...
        <div class="pt45">
                    ...
                    <div class="tabs_2">
                        <ul>
                            <li class="selected"><a href="#"><span>网络接入</span></a></li>
