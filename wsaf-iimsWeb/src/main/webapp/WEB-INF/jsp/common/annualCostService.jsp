...
$(function() {
	...
	$.postcontractCostDetail("${pageContext.request.contextPath}",id);
      ...
      $.getFileInfo("${pageContext.request.contextPath}","modelName=service&modelId="+QueryString.GetValue('id'),true);
            	...
            	<div class="w_bg">
                	...
                	<div class="Bottom">
                    	...
                    	<div class="Top">
                        	 ...
                        	 <h1 class="t_c">上海申通地铁集团有限公司<br>专项填写（维保公司）</h1>
               ...
               <tr>
                  <td class="lableTd t_r"><div class="red"> *</div>未支付</td>
                   ...
                   <td class="lableTd t_r"><div class="red"> *</div>支付率</td>
                  	<td><input  type="text" class="input_large" name="percent" /></td> 
                </tr>
                <tr>
