    ...
    <script type="text/javascript">
        $(function () {
                                        ...
                                        try {
                                            if (item == "businessStatus") {
                                                ...
                                                if (entry[item] == "YES") {
                                                    ...
                                                    $("[name=" + item + "]").parents("tr").after("<tr class=\"upload\"><td class=\"lableTd t_r\">资料</td><td colspan=\"3\"><table width=\"100%\" ><thead><tr><td  colspan=\"5\"><input id=\"" + item + "\" class=\"upload_button\" type=\"button\" value=\"浏览...\" /><div style=\"display:none\" class=\"myissue\">issue" + "aaa" + "</div><input type=\"button\" value=\"上传\"  onclick=\"$('#" + item + "').uploadify('upload','*');\"><input type=\"button\" value=\"取消\"  onclick=\"$('#" + item + "').uploadify('cancel','*');\"></td></tr><tr><td>文件名</td> <td>大小(kb)</td><td>上传时间</td><td colspan=\"2\">操作</td></tr></thead><tbody>" + info + "</tbody></table></td></tr>");
                                                    ...
                                                    $("#" + item).uploadify({
                                                        ...
                                                        'uploader': '<%=basePath%>attach/api/upload?groupName=' + item,
            ...
            $(".btnSubmit").click(function () {
                ...
                var otherData = "&id=" + QueryString.GetValue('id') + "&keyProducts={\"security\":\"{\\\"num\\\":\\\"" + $("#securityNum").val();
                ...
                otherData += "&businessCategory=" + $("select[name=businessCategory]").val() + "&initiateTime=" + d.getTime();
                ...
                otherData += "&notifyDeptLeader=NO&sysSecurityLevel=level";
                ...
                $.postsave2("${pageContext.request.contextPath}", "projectPlanForm", "securityLevel", otherData, "/securityLevel/" + QueryString.GetValue('toUrl') + "?id=" + QueryString.GetValue('id'), true, false, true, attachIds);

                location.href = "${pageContext.request.contextPath}/securityLevel/" + QueryString.GetValue('toUrl') + "?id=" + QueryString.GetValue('id');
            ...
            $("#btndel").click(function () {
                location.href = "${pageContext.request.contextPath}/securityLevel/securityLevelReview?id=" + QueryString.GetValue('id');
            });
                ...
                <div class="w_bg">
                    ...
                    <div class="Bottom">
                        ...
                        <div class="Top">
                                ...
                                <form id="projectPlanForm">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="input_large" name="systemName" maxlength="20" /></td>
                                            <td class="lableTd t_r">系统编号</td>
                                            <td>
                                                <input type="text" class="input_large" name="systemNum" maxlength="20" /></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                            ...
                                            <td colspan="3" style="padding: 0">
                                                <table width="100%" class="mytable3" id="businessSecurityDamage">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" value="level1_damage" class="level1">仅对公民、法人和其他组织的合法权益造成损害</td>
                                                            <td>
                                                                <input type="radio" name="myBusinessSecurityLevel" value="level1" disabled="disabled">第一级</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" value="level2_damage1" class="level2">对公民、法人和其他组织的合法权益造成严重损害</td>
                                                            <td rowspan="2">
                                                                <input type="radio" value="level2" name="myBusinessSecurityLevel" disabled="disabled">第二级</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" value="level2_damage2" class="level2">对社会秩序和公共利益造成损害</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" value="level3_damage1" class="level3">对社会秩序和公共利益造成严重损害</td>
                                                            <td rowspan="2">
                                                                <input type="radio" value="level3" name="myBusinessSecurityLevel" disabled="disabled">第三级</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" value="level3_damage2" class="level3">对国家安全造成损害</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" value="level4_damage1" class="level4">对社会秩序和公共利益造成特别严重损害</td>
                                                            <td rowspan="2">
                                                                <input type="radio" value="level4" name="myBusinessSecurityLevel" disabled="disabled">第四级</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" value="level4_damage2" class="level4">对国家安全造成严重损害</td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <input type="checkbox" value="level5_damage" class="level5">对国家安全造成特别严重损害</td>
                                                            <td rowspan="2">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input type="text" class="input_large"  readonly="readonly" name="levelConfirmDate" maxlength="10" /></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">专家评审情况</td>
                                            <td colspan="3">
                                                <select name="expertReview" class="input_small"></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">是否有主管部门</td>
                                            <td colspan="3">
                                                <select name="hasDeptIncharge" class="input_small"></td>
                                        </tr>
                                        <tr style="display: none">
                                            <td class="lableTd t_r">主管部门名称</td>
                                            <td>
                                                <input type="text" class="input_large" name="deptIncharge" maxlength="30" /></td>
                                            <td class="lableTd t_r">主管部门审批定级情况</td>
                                            <td>
                                                <select name="deptInchargeReview" class="input_small"></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">系统定级报告 </td>
                                            <td colspan="3">
                                                <select name="hasSysLevelFile" class="input_small"></td>
                                        </tr>
                                    </table>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2" id="applyInfo">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <select name="hasSysTipologyFile" class="input_small"></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">系统安全组织机构及管理制度</td>
                                            <td colspan="3">
                                                <select name="hasSysSecurityOrganFile" class="input_small"></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">系统安全保护设施设计实施方案或改建实施方案</td>
                                            <td colspan="3">
                                                <select name="hasSysProtectFile" class="input_small"></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">系统使用的安全产品清单及认证、销售许可证明</td>
                                            <td colspan="3">
                                                <select name="hasSysProductsFile" class="input_small"></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">系统等级测评报告</td>
                                            <td colspan="3">
                                                <select name="hasSysLevelReviewFile" class="input_small"></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">系统等级测评时间</td>
                                            <td colspan="3">
                                                <input type="text" readonly="readonly" class="input_large" name="sysLevelReviewDate" maxlength="30" /></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">专家评审情况</td>
                                            <td colspan="3">
                                                <select name="hasExpertReviewFile" class="input_small"></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">上级主管部门审批意见</td>
                                            <td colspan="3">
                                                <select name="hasDeptInchargeReviewFile" class="input_small"></td>
                                        </tr>
                                    </table>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2" id="Table1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="input_large" name="applyTime" disabled="disabled" /><input type="text" class="input_large" name="reportUnit" style="display: none" /></td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input type="text" class="input_large" name="initiateTime" disabled="disabled" /></td>
                                        </tr>
                            ...
                            <div class="mb10 t_c">
                                <input type="button" class="btnSubmit" value="保 存" />
                                &nbsp;
