  ...
  <head>
    ...
    <script type="text/javascript">
		 $(document).ready(function () {
        	$.postSearchFormResource("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
        	window.onfocus = function(){
        		var _page="1";
        		if($(".selected a").length>0&&$(".selected a").text()!="")
        			_page=$(".selected a").text();
        		
              $.postSearchFormResource("${pageContext.request.contextPath}","&pageSize=16&pageNum="+_page); 
          	 };
		...
		function close(){
			...
			function open(id){
				var a = document.getElementById("iframe_xx");
				a.style.display="";
				$.findByIdResource("${pageContext.request.contextPath}",id);
				}
			function open2(id){
			...
			function del(id){
				$.delByIdResource("${pageContext.request.contextPath}",id);
				}
			function save(id){
				var otherData="&status=finish";
           		 otherData+="&id="+id;
				$.postsaveResource("${pageContext.request.contextPath}","netResource",otherData);
			}
...
<tbody id="tb2"></tbody>
	...
	<div class="main">
        ...
        <div class="pt45">
                    ...
                    <div class="tabs_2">
                        <ul>
                            <li class="selected"><a href=""><span>网络接入台帐</span></a></li>
                 ...
                 <form id="projectAppform">
                  <table class="nwarp" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                     ...
                     <td class="t_r">MAC地址</td>
                      <td><input type="text" id="lreportUnit" name="macAddress" /></td>
                    </tr>
                  	<tr>
                        <td class="t_r">办理工程师</td>
                      <td><input type="text" id="lreportUnit" name="implementEngineer" /></td>
                      <td class="t_r">IP地址</td>
                      <td><input type="text" id="lreportUnit" name="ip" /></td>
                    </tr>
        	...
        	<table width="100%"  class="table_1" id="table1">
                <tbody>
                   <tr class="tit">
                       ...
                       <td class="sort"><a ><span class="fl">IP地址/子网掩码</span></a></td>
                       <td class="sort"><a ><span class="fl">mac地址</span></a></td>
