		 ...
		 $(document).ready(function () {
           ...
           $("#oututBtn").click(function(){
        	  var paging="";
         	  ...
         	  window.location.href="${pageContext.request.contextPath}"+"/basicCrud/vpnResource/export2Excel?"+content+"&type=vpnResource";
        ...
        <div class="pt45">
                    ...
                    <div class="tabs_2">
                        <ul>
                            ...
                            <li class="selected"><a href="#"><span>VPN访问</span></a></li>
