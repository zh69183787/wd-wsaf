    ...
    <script type="text/javascript">
		 $(document).ready(function () {
		  $(".closewindow").click(function(){
        	...
        	$.postSearchFormImplement("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
        	window.onfocus = function(){
        		var _page="1";
        		if($(".selected a").length>0&&$(".selected a").text()!="")
        			_page=$(".selected a").text();
        		
              $.postSearchFormImplement("${pageContext.request.contextPath}","&pageSize=16&pageNum="+_page); 
          	 };
