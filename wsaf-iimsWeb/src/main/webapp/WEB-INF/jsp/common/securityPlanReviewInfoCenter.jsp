                                    ...
                                    $("#btnSubmit2").click(function () {
                                        if ($("input[name=btnISPass]:checked").val() == "pass") {
                                            ...
                                            if (id != null) {
                                                ...
                                                otherData += "&id=" + id + "&status=infoDeptLeaderAudit" + "&initiateTime=" + d.getTime();
                                            }
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                   ...
                   <tr style="display: none" class="reviewNotPass">
                    <td class="td_1">&nbsp;</td>
                    <td>
                        <input id="mynotifyDeptLeader" type="checkbox" style="margin-right: 5px">通知工作负责人</td>
                </tr>
                    ...
                    <div class="Bottom">
                        ...
                        <div class="Top">
                            ...
                            <div class="mb10 t_c">
                                ...
                                <input type="button" id="btnSubmit" value="审 查" />
                                &nbsp;
