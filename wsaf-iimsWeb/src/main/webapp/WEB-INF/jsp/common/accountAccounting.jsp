  ...
  <head>
    ...
    <script type="text/javascript">
		 $(document).ready(function () {
        	$.postSearchFormAccount("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
        	window.onfocus = function(){
        		var _page="1";
        		if($(".selected a").length>0&&$(".selected a").text()!="")
        			_page=$(".selected a").text();
        		
              $.postSearchFormAccount("${pageContext.request.contextPath}","&pageSize=16&pageNum="+_page); 
          	 };
		...
		function close(){
			...
			function open(id){
				var a = document.getElementById("iframe_xx");
				a.style.display="";
				$.findByIdAccount("${pageContext.request.contextPath}",id);
				}
			function open2(id){
			...
			function del(id){
				$.delByIdAccount("${pageContext.request.contextPath}",id);
				}
			function save(id){
				var otherData="&status=finish";
           		 otherData+="&id="+id;
				$.postsaveAccount("${pageContext.request.contextPath}","accountResource",otherData);
			}
        ...
        <div class="pt45">
                    ...
                    <div class="tabs_2">
                        <ul>
                            ...
                            <li class="selected"><a href=""><span>系统账户台帐</span></a></li>
        	...
        	<table width="100%"  class="table_1" id="table1">
                <tbody>
                   <tr class="tit">
                       ...
                       <td class="sort"><a ><span class="fl">员工工号</span></a></td>
