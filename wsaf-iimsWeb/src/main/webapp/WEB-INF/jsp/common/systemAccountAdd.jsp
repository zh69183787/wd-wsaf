 ...
 $(function() {
	...
	$("#upload").uploadify({
        'auto' : false,
           ...
           'uploader' : '<%=basePath%>attach/api/upload?groupName="accountResource"',
						...
						_od+="&handlerLoginname="+$("#handler option:selected").val();
            			 ...
            			 _od+="&initiatorLoginname="+$("[name=applyerLoginname]").val();
	                	   ...
	                	   var _attachIds=$.getAttachId();
	                	   	  ...
	                	   	  $.FileSave("${pageContext.request.contextPath}","accountResource",fid,_attachIds);
	                	   	window.close();
							location.href = Url
    	  ...
    	  $( "#dialog-confirm" ).dialog({
             ...
             buttons: {
	           ...
	           $("[name=applyBusinessType]").change(function(){
					...
					if($("[name=applyBusinessType]").val()!="portalAccount"){
        ...
        <div class="gray_bg">
            	...
            	<div class="w_bg">
                	...
                	<div class="Bottom">
                    	...
                    	<div class="Top">
                        	 ...
                        	 <h1 class="t_c">上海申通地铁集团有限公司<br>信息系统账户申请/注销审批办理表</h1>
            ...
            <form id="projectPlanForm">
              ...
              <tr>
                  ...
                  <td >
                  <!-- input  type="text" class="input_large" name="post" /-->
                   <select name="post" class="input_large" name="post" >
                      <option value="" selected>请选择</option>
               ...
               <tr>
                  ...
                  <td ><input  type="text" class="input_large" name="loginName" /></td> 
                      
                </tr>
                <tr style="display:none" id="sys">
                  <td class="lableTd t_r"><div class="red">* </div>系统名称</td>
                  <td ><input  type="text" class="input_large" name="sysName" /></td> 
                </tr>
                <tr>
                	<td id="reason" class="lableTd t_r"><div class="red"> *</div>业务申请原因</td>
