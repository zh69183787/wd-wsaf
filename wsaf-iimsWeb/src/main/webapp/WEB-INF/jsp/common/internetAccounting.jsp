  ...
  <head>
    ...
    <script type="text/javascript">
		 $(document).ready(function () {
        	$.postSearchFormInternet("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
        	window.onfocus = function(){
        		var _page="1";
        		if($(".selected a").length>0&&$(".selected a").text()!="")
        			_page=$(".selected a").text();
        		
              $.postSearchFormInternet("${pageContext.request.contextPath}","&pageSize=16&pageNum="+_page); 
          	 };
		...
		function close(){
			...
			function open(id){
				var a = document.getElementById("iframe_xx");
				a.style.display="";
				$.findByIdInternet("${pageContext.request.contextPath}",id);
				}
			function open2(id){
			...
			function del(id){
				$.delByIdInternet("${pageContext.request.contextPath}",id);
				}
			function save(id){
				var otherData="&status=finish";
           		 otherData+="&id="+id;
				$.postsaveInternet("${pageContext.request.contextPath}","InternetResource",otherData);
			}
        ...
        <div class="pt45">
                    ...
                    <div class="tabs_2">
                        <ul>
                            ...
                            <li class="selected"><a href=""><span>特定互联网台帐</span></a></li>
                  ...
                  <table class="nwarp" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                     ...
                     <td class="t_r">业务类型</td>
                      <td><input type="text" id="lreportUnit" name="applyBusinessType" /></td>
                    </tr>
        	...
        	<table width="100%"  class="table_1" id="table1">
                <tbody>
                   <tr class="tit">
                       ...
                       <td class="sort"><a ><span class="fl">开通位置</span></a></td>
