								...
								if (data.success == true&&data.result&&JSON.stringify(data.result) != "[]") 
								{
									...
									for ( var item in entry) 
									{
									 ...
									 $("#tbfj tbody a.del").click(function(){
											...
											$.getFileInfo("${pageContext.request.contextPath}","modelName=resourceManage&modelId="+QueryString.GetValue('id'),true);
									});
								}
							}
						}
			...
			$.postResourceManageDetail = function(firUrl,id,isread,isPreliminaryPersonnel){
			 ...
			 if(firUrl!="")
			   {	
					 ...
					 $.ajax({
						   async: false,
						    url : firUrl+"/basicCrud/netResource/get/"+id,
							type : 'post',
							success: function(data, status, xhr) {
								if (status == "success" && data != null)
								{
										...
										if(entry.status=="waitForImplement"){
									          ...
									          if(entry.status=="waitForImplement"){
												...
												$.postsave(firUrl,"projectPlanForm",otherData);
												 window.close();
												  location.href = Url+ "/netResource/resourceManageList";
						...
						if(entry.status=="waitForImplement"||entry.status=="selfDealWith"){
                    			...
                    			item+="<td> <input  type='text' class='input_large' name='implementEngineer' /></td>";
                  				...
                  				item+="<tr>";
                  				item+="<td class='lableTd t_r'><div class='red'> *</div>开通位置</td>";
                    			item+="<td> <input  type='text' class='input_large' name='implementPlace' /></td>";
                    			item+="<td class='lableTd t_r'><div class='red'> *</div>交换机设备编号</td>";
                    			item+="<td> <input  type='text' class='input_large' name='switchDeviceCode' /></td>";
               				    item+="</tr>";
               				    
               				 	item+="<tr>";
             					item+="<td class='lableTd t_r'><div class='red'> *</div>端口</td>";
                 				item+="<td> <input  type='text' class='input_large' name='port' /></td>";
                 				item+="<td class='lableTd t_r'><div class='red'> *</div>VLAN</td>";
                 				item+="<td> <input  type='text' class='input_large' name='vlan' /></td>";
            				    item+="</tr>";
            				    
            				    item+="<tr>";
             					item+="<td class='lableTd t_r'><div class='red'> *</div>业务状态</td>";
                 				item+="<td> <select name='netStatus' class='input_large'> <option value=''>请选择</option> <option value='up'>UP</option>"; 
                    			item+="<option value='down'>DOWN</option></select></td>";
                 				item+="<td class='lableTd t_r'><div class='red'> *</div>接口信息</td>";
                 				item+="<td> <input  type='text' class='input_large' name='interfaceInfo' /></td>";
            				    item+="</tr>";
            				    
            				    item+="<tr>";
             					item+="<td class='lableTd t_r'><div class='red'> *</div>ip地址/掩码</td>";
                 				item+="<td> <input  type='text' class='input_large' name='ip' /></td>";
                 				item+="<td class='lableTd t_r'><div class='red'> *</div>mac地址</td>";
                 				item+="<td> <input  type='text' class='input_large' name='mac' /></td>";
            				    item+="</tr>";
            				    
            				    item+="<tr>";
             					item+="<td class='lableTd t_r'><div class='red'> *</div>网关</td>";
                 				item+="<td> <input  type='text' class='input_large' name='gateway' /></td>";
                 				item+="<td class='lableTd t_r'><div class='red'> *</div>系统名</td>";
                 				item+="<td> <input  type='text' class='input_large' name='sysName' /></td>";
            				    item+="</tr>";
							...
							if(entry.status=="finish"){
                    			...
                    			item+="<td> <input disabled type='text' class='input_large' name='implementEngineer' /></td>";
                  				...
                  				item+="<tr>";
                  				item+="<td class='lableTd t_r'><div class='red'> *</div>开通位置</td>";
                    			item+="<td> <input  disabled type='text' class='input_large' name='implementPlace' /></td>";
                    			item+="<td class='lableTd t_r'><div class='red'> *</div>交换机设备编号</td>";
                    			item+="<td> <input disabled  type='text' class='input_large' name='switchDeviceCode' /></td>";
               				    item+="</tr>";
               				    
               				 	item+="<tr>";
             					item+="<td class='lableTd t_r'><div class='red'> *</div>端口</td>";
                 				item+="<td> <input disabled  type='text' class='input_large' name='port' /></td>";
                 				item+="<td class='lableTd t_r'><div class='red'> *</div>VLAN</td>";
                 				item+="<td> <input disabled  type='text' class='input_large' name='vlan' /></td>";
            				    item+="</tr>";
            				    
            				    item+="<tr>";
             					item+="<td class='lableTd t_r'><div class='red'> *</div>业务状态</td>";
                 				item+="<td> <select disabled name='netStatus' style='width:160px;'> <option value=''>请选择</option> <option value='up'>UP</option>"; 
                    			item+="<option value='down'>DOWN</option></select></td>";
                 				item+="<td class='lableTd t_r'><div class='red'> *</div>接口信息</td>";
                 				item+="<td> <input disabled  type='text' class='input_large' name='interfaceInfo' /></td>";
            				    item+="</tr>";
            				    
            				    item+="<tr>";
             					item+="<td class='lableTd t_r'><div class='red'> *</div>ip地址/掩码</td>";
                 				item+="<td> <input disabled  type='text' class='input_large' name='ip' /></td>";
                 				item+="<td class='lableTd t_r'><div class='red'> *</div>mac地址</td>";
                 				item+="<td> <input disabled  type='text' class='input_large' name='mac' /></td>";
            				    item+="</tr>";
            				    
            				    item+="<tr>";
             					item+="<td class='lableTd t_r'><div class='red'> *</div>网关</td>";
                 				item+="<td> <input  disabled type='text' class='input_large' name='gateway' /></td>";
                 				item+="<td class='lableTd t_r'><div class='red'> *</div>系统名</td>";
                 				item+="<td> <input disabled  type='text' class='input_large' name='sysName' /></td>";
            				    item+="</tr>";
									...
									$( "[name=implementTime]" ).datepicker({ dateFormat:"yy-mm-dd"});         
												...
												if($("input[name=btnISPass]:checked").val()=="pass")
										         {
													...
													var d = new Date();
														...
														if(entry.status=="innerApproval")
														  {		
														 otherData+="&id="+QueryString.GetValue('id')+"&initiator="+$("[name=handler]").val()+"&initiatorLoginname="+entry.handlerLoginname+"&handler=方政&handlerLoginname=G01007000383&status=infoDeptApproval";
										...
										{ 										
											...
											if($("[name="+item+"]").length > 0)
												{
												    if(item=="applyTime"||item=="initiateTime"||item=="implementTime"){//||item=="implementTime"
												       ...
												       $("[name="+item+"]").val(entry[item].substring(0,10));
												    	...
												    	$("[name=handler]").val(entry[handler]);
													}
                ...
                <div class="divB">
                	...
                	<div class="con">
						...
						<ul class="button clearfix" style="filter:Gray">
                        	...
                        	<li class="disable"><a  class="bat" href="/iims/netResource/resourceManageList">批量审核</a></li>
            ...
            <form id="projectPlanForm">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                ...
                <tr>
                    ...
                    <td> <input  disabled="disabled" type="text" class="input_large" name="userName" /></td>
 					<td class="lableTd t_r" ><div class="red"> *</div>申请类型</td>
                    	<td >
                    	<select disabled name="applyType" class="input_large" name="applyType" >
               ...
               <tr>
                ...
                <tr>
                   ...
                   <td> 
                  	<select disabled name="equipmentType" class="input_large"  >
                      <option value="" selected>请选择</option>
