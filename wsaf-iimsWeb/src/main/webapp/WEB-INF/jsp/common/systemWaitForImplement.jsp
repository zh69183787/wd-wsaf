    ...
    <script type="text/javascript">
		 $(document).ready(function () {
        	...
        	window.onfocus = function(){
              ...
              $.postSearchForm2("${pageContext.request.contextPath}","&pageSize=16&pageNum="+_pager); 
          	 }
        	...
        	$(".topage").click(function(){
         		$.postSearchForm2(firUrl,"&pageSize=16&pageNum="+$(this).text(),isleader);
            ...
            $(".prepage").click(function(){
         	 ...
         	 if(nowpage>1)
         		...
         		$.postSearchForm2("${pageContext.request.contextPath}","&pageSize=16&pageNum="+topage),isleader;
         		 }
        		}); 
           ...
           $(".nextpage").click(function(){
         	 ...
         	 if(nextpage<=parseInt($("#gopage").attr("max")))
        		   $.postSearchForm2("${pageContext.request.contextPath}","&pageSize=16&pageNum="+nextpage,isleader);
           ...
           $("#oututBtn").click(function(){
        	  var paging="";
         	  ...
         	  window.location.href="${pageContext.request.contextPath}"+"/basicCrud/accountResource/export2Excel?"+content+"&type=accountResource";
        ...
        <div class="pt45">
                    ...
                    <div class="tabs_2">
                        <ul>
                            ...
                            <li class="selected"><a href="#"><span>系统账户申请</span></a></li>
                            ...
                            <li><a href="/iims/internetResource/internetAccessWaitForImplement"><span>互联网访问</span></a></li>
