  ...
  <head>
    ...
    $(function() {
	  ...
	  if($("[name=projectId]").val()!=""&&$("[name=projectId]").val()!=null){
  		...
  		$.postSearchFormSpecialOther("${pageContext.request.contextPath}","&projectId="+projectId);
  		$.postprojectCostDetail("${pageContext.request.contextPath}",projectId); 	
  	}
            	...
            	<div class="filter_search p8"><!--这里根据内容做样式调整。1、筛选：filter_sandglass 2、搜索filter_search 3、提示：.filter_tips 背景图会改变。-->
                  <table class="nwarp" width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td colspan="10" class="t_c">
                       	<div class="red"> *</div>专项名称<input type="text" class="input_large"  name="projectName"  />&nbsp;
                       	<div class="red"> *</div>上报预算<input type="text" class="input_large" name="reportBudget"  />&nbsp;
                       	<div class="red"> *</div>下达预算<input type="text" class="input_large" name="budget"  />
