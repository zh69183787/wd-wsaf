        ...
        $(function () {
            $.postSecurityLevelDetail = function (firUrl, id) {
                if (firUrl != "") {
                    $.ajax({
                        async: false,
                        url: firUrl + "/basicCrud/securityLevelCompany/get/" + id,
                        type: 'post',
                        success: function (data, status, xhr) {
                            ...
                            if (status == "success" && data != null) {
                                if (data.success == true ) {
                                    ...
                                    $("#mycompany").val(data.result.company);
                                    $("#companyId").text(data.result.companyId);
            ...
            if (QueryString.GetValue('id') != null) {
                $("#btnSubmit").click(function () {
               	 ...
               	 if($("#companyId").text()==null||$("#companyId").text()=="")
    				 yanzhen+="公司名字错误\r";
                    ...
                    var otherData = "&id=" + QueryString.GetValue('id') +"&company="+$("#mycompany").val();
                    $.postSave({"url":"${pageContext.request.contextPath}","formName":"projectPlanForm","isGetData":true,"modname":"securityLevelCompany","otherData":otherData,"isClose":true});
                });
                ...
                $("#btndel2").click(function () {
                    $.postSave({"url":"${pageContext.request.contextPath}","modname":"securityLevelCompany","otherData":"id=" + QueryString.GetValue('id') + "&removed=1","isClose":true});
                });
                ...
                <div class="w_bg">
                    ...
                    <div class="Bottom">
                        ...
                        <div class="Top">
                            ...
                            <h1 class="t_c">上海申通地铁集团有限公司<br>单位基础信息</h1>
