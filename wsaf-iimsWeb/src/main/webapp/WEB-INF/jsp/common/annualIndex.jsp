  ...
  <head>
    ...
    <script type="text/javascript">
		$(document).ready(function () {
			//$(".pt45").css("width","1746px");
			//$(".main").css("width","1746px");
			...
			if(isIE){
				$("#service").click(function(){
					$(".pt45").css("width","1367px");
					$(".main").css("width","1367px");
				});
				...
				$("#service").click(function(){
					$(".pt45").css("width","1515px");
					$(".main").css("width","1515px");
				});
				$("#organ").click(function(){
					$(".pt45").css("width","1515px");
					$(".main").css("width","1515px");
			...
			$.tab();
			var isReview = $.isReview("${pageContext.request.contextPath}");
			if(isReview==false){
			...
			$("#searchbtn").click(function(){
				if(isReview==true){
					$.postSearchFormIndex_1("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
					$.postSearchFormIndex_2("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
					$.postSearchFormIndex_3("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
				}else{
		...
		function addService(firUrl){
		    ...
		    }else if($("#organ").attr("class")=="selected"){
		    	window.open("/iims/annualCost/annualCostAddOrgan");
		    }else{
		...
		function delSpecial(id){
			...
			$.postDeleSpecial("${pageContext.request.contextPath}",id);
			$.postSearchFormIndex_3("${pageContext.request.contextPath}","&pageSize=16&pageNum=1");
		};
        ...
        <div class="con">
        	...
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td class="td_1" colspan="2"><div class="red"> *</div>年度</td>
				<td><input  name="year"></input></td>
              </tr>
	...
	<div class="main">
      ...
      <div class="filter">
        ...
        <div class="fn clearfix" >
           <!--xinxi-->
           <div>
             <input type="button" id="addbtn" value="新 增"  onclick="addService();"  >
             </div>
         </div>
      </div>
        <!--Filter End-->
