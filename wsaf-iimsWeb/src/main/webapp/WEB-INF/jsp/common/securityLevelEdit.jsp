    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".btnSubmit").click(function () {
                ...
                var otherData = "&id=" + QueryString.GetValue('id') + "&status=" + mystate + "&businessStatus=new&keyProducts={\"security\":\"{\\\"num\\\":\\\"" + $("#securityNum").val();
                                ...
                                <form id="projectPlanForm">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2" id="applyInfo">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <input type="text" class="input_large" name="sysLevelReviewDate" maxlength="30" /></td>
                                        </tr>
                                        <tr>
                                            <td class="lableTd t_r">专家评审情况</td>
                                            <td colspan="3">
