...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var myDate = new Date();
            $("[name=planYear]").val(myDate.getFullYear());
            ...
            $("#planType li").planTypeSp({"url":"${pageContext.request.contextPath}","type":0,"planId":$("#thisId").val(),"otherData":"&finished=0"});
            
            window.onfocus = function () {
            	$.planTypeSp2({"url":"${pageContext.request.contextPath}","type":0,"planId":$("#thisId").val(),"otherData":"&finished=0"});
            }
            ...
            $("#btnSave").click(function () {
                ...
                yanzhen += $.customVerification("#securityPlanDetailTable");
                ...
                var yanz = "";
                if ($("#thisId").val() == null || $("#thisId").val() == "") {

                    if ($("[name=planYear] option:selected").val() == null || $("[name=planYear] option:selected").val() == "")
                        yanz += "请先填写计划年度\r";
                    ...
                    var otherData = "&ishistory=0&company=" + $("[name=company] option:selected").val() + "&businessStatus=new&status=draft" + "&applyTime=" + d.getTime() + "&initiateTime=" + d.getTime();
                    ...
                    $.ajax({
                        url: "${pageContext.request.contextPath}/basicCrud/securityPlan/save",
                        type: 'post',
                        async: false,
                        data: $("#projectPlanForm").serialize() + otherData,
                        success: function (data, status, xhr) {
                            if (status == "success" && data != null) {
                                if (data.success == true && data.result != null) {
                                    $("#thisId").val(data.result.id);
                                }
                                else {
                                    alert("修改失败");
                                    return false;
                ...
                {
                	$("[name=planYear]").attr("disabled",true);
                }

                var otherData = "&finished=0&planId=" + $("#thisId").val() + "&projectNum="+$.ProjectNumSp("${pageContext.request.contextPath}");
            ...
            $(".btnSubmit").click(function () {
                ...
                var otherData = "&ishistory=0&company=" + $("[name=company] option:selected").val() + "&businessStatus=new&status=" + mystate + "&applyTime=" + d.getTime() + "&initiateTime=" + d.getTime();
                otherData += "&initiator=" + $("input[name=applyer]").val() + "&initiatorLoginname=" + $("input[name=applyerLoginname]").val()+"&planYear="+$("[name=planYear] option:selected").val();
                otherData += "&handler=" + $("select#principalPeople option:selected").text() + "&handlerLoginname=" + $("select#principalPeople option:selected").val();

                if ($("#thisId").val() != null && $("#thisId").val() != "")
                otherData += "&id=" + $("#thisId").val();
            ...
            <form id="securityPlanDetailFrom">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="securityPlanDetailTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <input readonly="readonly" name="planStartTime" type="text" class="input_small" maxlength="10"></td>
                    </tr>
                    <tr>
                        <td class="fr">计划结束时间：</td>
                        <td>
                            <input readonly="readonly" name="planEndTime" type="text" class="input_small" maxlength="10"></td>
                    </tr>
                    <tr>
                        <td class="fr">费用(元)：</td>
                        <td>
                                ...
                                <form id="projectPlanForm">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                        ...
                                        <tr class="companyAddress">
                                            ...
                                            <td colspan="3">
                                                <select type="text" name="planYear" class="input_small"></select>
                                            </td>
                                        </tr>
                                    </table>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2" id="myTable">
                                        <thead>
                                            <th colspan="4">
                                                ...
                                                <span class="fr pt5 mr5">
                                                    <input type="button" id="addSecurityPlan" value="新增" /></span>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2" id="applyInfo">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="input_large" name="applyer" readonly /><input type="text" class="input_large" id="applyerLoginname" name="applyerLoginname" readonly style="display: none" /><input type="text" class="input_large" id="thisId" readonly style="display: none" /></td>
                                        </tr>
                                        <tr>
