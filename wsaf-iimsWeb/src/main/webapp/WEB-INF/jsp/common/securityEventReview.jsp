                ...
                $("#btnSubmit2").click(function () {
                	  ...
                	  if ($("input[name=btnISPass]:checked").val() == "pass") {
                          ...
                          if (QueryString.GetValue('id') != null) {
                              ...
                              if(Number($("[name=eventLevel]").val())>=3)
                            	  {
                            	  otherData+="&status=deptLeaderReview";
                            	  var roleInfo=$.getRoleIdentity("${pageContext.request.contextPath}",$("[name=companyId]").val(),"principal");
                          ...
                          var otherData = "";
                          if (QueryString.GetValue('id') != null) {
                              otherData += "&id=" + QueryString.GetValue('id') + "&status=businessBack";
