...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("[name=startTime]").datepicker({ dateFormat:"yy-mm-dd"}).click(function(){$(".ui-state-default").removeAttr("href"); });
            $("[name=finishTime]").datepicker({ dateFormat:"yy-mm-dd"}).click(function(){$(".ui-state-default").removeAttr("href"); });
            ...
            $("#btndel").click(function () {
           	 ...
           	 $.postSave({"url":"${pageContext.request.contextPath}","formName":"projectPlanForm","modname":"securityIssue","otherData":"&removed=1&id=" + QueryString.GetValue('id'),"isClose":true});
           });
            ...
            $(".btnSubmit").click(function () {
                 ...
                 $(this).attr("disabled", true);
                 $.postSave({"url":"${pageContext.request.contextPath}","formName":"projectPlanForm","isGetData":true,"modname":"securityIssue","otherData":otherData,"isClose":true});
            });
            }
        });
    </script>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="issueSource" class="input_large" maxlength="20"></td>
                                            </tr>
                                              <tr>
                                                <td class="lableTd t_r">问题描述</td>
                                                <td colspan="3" >
                                                    <textarea name="issueDescription" rows="2"  maxlength="200"></textarea></td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                       <select name="issueCate" class="input_large"></select></td>
                                                <td class="lableTd t_r">科目</td>
                                                <td>
                                                     <select name="issueSubject" class="input_large"></select></td>
                                            </tr>
                                            <tr>
                                                <td class="lableTd t_r">科目子类</td>
                                                <td colspan="3">
                                                    <select name="issueItem" class="input_large"></select></td>
                                     ...
                                     <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td colspan="3" >
                                                    <textarea name="rectifyPlan" rows="2"  maxlength="200"></textarea></td>
                                               
                                            </tr>
                                            <tr>
                                                <td class="lableTd t_r">实际情况</td>
                                                 <td colspan="3" >
                                                    <textarea name="actualSituation" rows="2"  maxlength="200"></textarea></td>
                                                
                                            </tr>
                                            <tr>
                                                <td class="lableTd t_r">计划开始时间</td>
                                                 <td >
                                                   <input type="text" readonly="readonly" name="startTime" class="input_small" maxlength="8"></td>
                                                 <td class="lableTd t_r">计划完成时间</td>
                                                 <td >
                                                   <input type="text" readonly="readonly" name="finishTime" class="input_small" maxlength="8"></td>
                                            </tr>
                                             <tr>
                                                <td class="lableTd t_r">整改方案备注</td>
                                                 <td colspan="3" >
                                                    <textarea name="rectifyRemark" rows="2"  maxlength="200"></textarea></td>  
                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="lableTd t_r">复核情况</td>
                                                 <td colspan="3" >
                                                    <textarea name="checkSituation" rows="2"  maxlength="200"></textarea></td>
                                             ...
                                             <tr>
                                                <td class="lableTd t_r">跟踪信息备注</td>
                                                 <td colspan="3" >
                                                    <textarea name="traceRemark" rows="2"  maxlength="200"></textarea></td>  
                                            </tr>
