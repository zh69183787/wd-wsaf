                                    ...
                                    $("#btnSubmit2").click(function () {
                                        if ($("input[name=btnISPass]:checked").val() == "pass") {
                                            ...
                                            if (id != null) {
                                                ...
                                                otherData += "&id=" + id + "&initiateTime=" + d.getTime();
                                            }

                                            $(this).attr("disabled", true);
                                            $.postsave2(firUrl, "projectPlanForm", "securityLevel", otherData, "/securityLevel/securityLevelList", false, true, false, "");

                                        }
                                        else if ($("input[name=btnISPass]:checked").val() == "notPass") {
                                            var otherData = "";
                                            if (id != null) {
                                                otherData += "&id=" + id + "&status=policeBack";
                                            }
                                            ...
                                            otherData += "&handler=" + entry.handler;
                                            otherData += "&handlerLoginname=" + entry.handlerLoginname;
                                            otherData += "&initiator=" + entry.handler;
        ...
        <div class="con">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>公安计划审核意见：<input name="btnISPass" type="radio" value="pass" style="margin-left: 20px">通过<input name="btnISPass" type="radio" value="notPass" style="margin-left: 10px">不通过</td>
