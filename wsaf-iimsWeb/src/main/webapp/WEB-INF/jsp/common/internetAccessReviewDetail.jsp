					 ...
					 $.ajax({
						...
						if(entry.status=="waitForImplement"||entry.status=="selfDealWith"){
                    			...
                    			item+="<td> <input  type='text' class='input_large' name='implementUser' /></td>";
               				    item+="</tr>";
               				 	item+="<tr>";
               				 	item+="<td class='lableTd t_r'><div class='red'> *</div>申请业务类型</td>";
               				 	item+="<td> <select name='applyBusinessType' class='input_large'><option value='groupInternet' selected='selected'>集团互联网业务（仅访问官方网站、企业邮箱，默认选项）</option>"; 
                 				item+="<option value='commonInternet'>访问常用互联网资源（必须描述清楚访问用途和方式）</option><option value='specialInternet'>访问特殊互联网资源（有特殊应用需求才可申请）</option><option value='other'>其他</option></select></td>";
                 				item+="</tr>";
                 				item+="<tr>";
							...
							if(entry.status=="finish"){
                    			...
                    			item+="<td> <input disabled type='text' class='input_large' name='implementUser' /></td>";
               				    item+="</tr>";
               				 	item+="<tr>";
               				 	item+="<td class='lableTd t_r'><div class='red'> *</div>申请业务类型</td>";
            				 	item+="<td> <select disabled name='applyBusinessType' class='input_large'> <option value='groupInternet' selected>集团互联网业务（仅访问官方网站、企业邮箱，默认选项）</option>"; 
              					item+="<option value='commonInternet'>访问常用互联网资源（必须描述清楚访问用途和方式）</option><option value='specialInternet'>访问特殊互联网资源（有特殊应用需求才可申请）</option><option value='other'>其他</option></select></td>";
              					item+="</tr>";
               				 	item+="<tr>";
             					item+="<td class='lableTd t_r'><div class='red'> *</div>开通情况</td>";
                ...
                <div class="divB">
                	...
                	<div class="con">
						...
						<ul class="button clearfix" style="filter:Gray">
                        	...
                        	<li class="disable"><a  class="bat" href="/iims/internetResource/internetAccessList">批量审核</a></li>
            	...
            	<div class="w_bg">
                	...
                	<div class="Bottom">
                    	...
                    	<div class="Top">
                        	 ...
                        	 <h1 class="t_c">上海申通地铁集团有限公司<br>特定互联网访问申请/注销审批办理表</h1>
            ...
            <form id="projectPlanForm">
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_2">
                ...
                <tr>
                     ...
                     <td><input disabled type="text" class="input_large" name="post" /></td>
                </tr>
                <tr>
