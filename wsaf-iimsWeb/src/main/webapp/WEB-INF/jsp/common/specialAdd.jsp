  ...
  <head>
    ...
    $(function() {
    	...
    	if($("[name=specialId]").val()!=""&&$("[name=specialId]").val()!=null){
    		...
    		$.postSearchFormSpecialBudget("${pageContext.request.contextPath}","&specialId="+specialId_1);
		...
		if(b.length!=0){
			if(b[0].innerHTML=="2015"){
				for(var i=0;i<c.length;i++){
					if(c[i].innerHTML=="已批复"){
						var ii = i+1;
    	...
    	window.onfocus = function(){
    		if($("[name=specialId]").val()!=""&&$("[name=specialId]").val()!=null){
        		...
        		$.postSearchFormSpecialBudget("${pageContext.request.contextPath}","&specialId="+specialId_2);
	...
	<div class="main">
      ...
      <div class="filter">
            	...
            	<div class="filter_search p8"><!--这里根据内容做样式调整。1、筛选：filter_sandglass 2、搜索filter_search 3、提示：.filter_tips 背景图会改变。-->
                  <table class="nwarp" width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td colspan="10" class="t_c">
                       	<div class="red"> *</div>项目预算年度<input type="text" class="input_large" name="year"  />
                       	<div class="red"> *</div>项目年度预算<input type="text" class="input_large"  name="budget"  />&nbsp;
        ...
        <div class="fn clearfix" >
           <!--xinxi-->
           <div>
             <input type="button" id="addProject" value="新 增 项 目" >
             <input type="button" id="addContract" value="新 增 合 同" >
             </div>
         </div>
      </div>
        <!--Filter End-->
