        ...
        $(function () {
                                                ...
                                                $("#btnSubmit2").click(function () {
                                                    ...
                                                    if ($("input[name=btnISPass]:checked").val() == "pass") {
                                                        ...
                                                        if (id != null) {
                                                            ...
                                                            otherData += "&id=" + id + "&status=infoDeptReview" + "&initiateTime=" + d.getTime();
                                                        }

                                                        $(this).attr("disabled", true);
                                                        $.postsave2(firUrl, "projectPlanForm", "securityLevel", otherData + "&suggestion=" + $("[name=suggestion]").val(), "/securityLevel/securityLevelList", false, true, false, "");
                                                        ...
                                                        var otherData = "";
                                                        if (id != null) {
                                                            otherData += "&id=" + id + "&status=deptLeaderBack";
                                                        }
                                                        var d = new Date();
                                                        ...
                                                        $.postsave2(firUrl, "projectPlanForm", "securityLevel", otherData + "&initiateTime=" + d.getTime() + "&suggestion=" + $("[name=suggestion]").val(), "/securityLevel/securityLevelList", false, true, false, "");
                                                        $(this).attr("disabled", true);
                                                    }
            ...
            if (QueryString.GetValue('id') != null) {
                ...
                $("#btnEdit").click(function () {
                    location.href = "${pageContext.request.contextPath}/securityLevel/securityLevelLeaderEdit?id=" + QueryString.GetValue('id') + "&toUrl=securityLevelReview";
                });
